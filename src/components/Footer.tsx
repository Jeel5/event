      ...
      <div className="luxe-container py-16 md:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
          ...
          <div className="mt-8 lg:mt-0">
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/services/decoration-services" className="text-white/70 hover:text-luxe-gold transition-colors elegant-underline">
                  Decoration
                </Link>
              </li>
              <li>
          ...
          <div className="mt-8 lg:mt-0">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <a href="tel:+918866793934" className="text-white/70 hover:text-luxe-gold transition-colors">
                  8866793934
                </a>
              </li>
            </ul>
